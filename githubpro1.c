...
;
    ...
    for(p = serverinfo; p != NULL; p = p->ai_next) {
        printf("inside for loop p->ai_protocol:%d\n", p->ai_protocol); //2 for af_inet, 1 for sock_stream, 6 for socket protocol(tcp)
    ...
    printf("out of the connection loop\n");
